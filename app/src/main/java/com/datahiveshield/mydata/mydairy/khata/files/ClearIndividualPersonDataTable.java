...
public class ClearIndividualPersonDataTable extends Activity {
    Button clearData;
...
//            Typeface myFont=Typeface.createFromAsset(this.getAssets(),"fonts/TradeWinds-Regular.ttf");
        ...
        groupAccessed.setText("Person Accessed : "+Params.CURRENT_GROUP_DB_NAME );
        ...
        MyDbHandlerIndividualPersonConfigs db=new MyDbHandlerIndividualPersonConfigs(ClearIndividualPersonDataTable.this);
        ...
        clearData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try
                {
                    //function call from MyDbHandlerIndividualPersonConfigs to delete table data
                    db.clearIndividualPersonDataTable();
                    String msg="Table data cleared successfully";
                    ga.alertDialogBox(ClearIndividualPersonDataTable.this,msg,"Cleared");
                }
                catch (Exception e)
                {
                    String msg="No data to clear\n" +
                            "Error:"+e.getMessage().toString();
                    ga.alertDialogBox(ClearIndividualPersonDataTable.this,msg,"Not cleared");
                }
            }
        });
    }
