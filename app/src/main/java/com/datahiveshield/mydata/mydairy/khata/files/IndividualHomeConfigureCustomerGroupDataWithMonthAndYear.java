...
import com.datahiveshield.mydata.mydairy.khata.files.data.MyDbHandlerIndividualPerson;
...
public class IndividualHomeConfigureCustomerGroupDataWithMonthAndYear extends AppCompatActivity {
...
//        mContext=IndividualHomeConfigureCustomerGroupDataWithMonthAndYear.this;
...
//            f.mkdirs();
//        }
        MyDbHandlerIndividualPerson db=new MyDbHandlerIndividualPerson(IndividualHomeConfigureCustomerGroupDataWithMonthAndYear.this);
        SQLiteDatabase db1 = db.getWritableDatabase();//pass this to create table
//        db.createConfigureCustomerGroupDataTableWithMonthAndYear(db1);//Database table to store new person name ,create if not exits
        try {
        ...
        createNewGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(now-lastTimeClicked<TIME_INTERVAL_GAP)
                    return;
                lastTimeClicked=now;
//                startActivity(new Intent(IndividualHomeConfigureCustomerGroupDataWithMonthAndYear.this,CreateNewCustomerGroup.class));
//                Intent intent = new Intent(IndividualHomeConfigureCustomerGroupDataWithMonthAndYear.this,CreateNewConfigureCustomerGroupDataWithMonthAndYear.class);
//                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                startActivity(intent);
                startActivity(new Intent(IndividualHomeConfigureCustomerGroupDataWithMonthAndYear.this,CreateNewConfigureIndividualPersonDataWithMonthAndYear.class));
...
//                public void onClick(View view) {
//
////                   startActivity(new Intent(IndividualHomeConfigureCustomerGroupDataWithMonthAndYear.this, UpdateCustomerGroup.class));
//                    Intent intent = new Intent(IndividualHomeConfigureCustomerGroupDataWithMonthAndYear.this,UpdateConfigureCustomerGroupDataWithMonthAndYear.class);
//                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                    startActivity(intent);
//
//
        ...
        deleteGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(now-lastTimeClicked<TIME_INTERVAL_GAP)
                    return;
                lastTimeClicked=now;
                startActivity(new Intent(IndividualHomeConfigureCustomerGroupDataWithMonthAndYear.this,DeleteConfigureIndividualPersonDataWithMonthAndYear.class));
//                Intent intent = new Intent(IndividualHomeConfigureCustomerGroupDataWithMonthAndYear.this,DeleteCustomerGroup.class);
//                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                startActivity(intent);
...
//        MyDbHandlerIndividual db=new MyDbHandlerIndividual(IndividualHomeConfigureCustomerGroupDataWithMonthAndYear.this);
...
//            customerDatabasesArrayList.add("");
        ...
        {
            Log.d("dbsvm","Error in retrieving individual person data \nError "+e.getMessage().toString());
        }
...
//                recyclerViewAdapter = new RecyclerViewAdapter(IndividualHomeConfigureCustomerGroupDataWithMonthAndYear.this,a );
//                Collections.sort(a);
