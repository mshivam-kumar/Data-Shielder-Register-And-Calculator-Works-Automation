...
public class DeleteCustomerGroup extends Activity {
   ...
   private static final long TIME_INTERVAL_GAP=500;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.delete_customer_group);
...
//            Typeface myFont=Typeface.createFromAsset(this.getAssets(),"fonts/TradeWinds-Regular.ttf");
        ...
        MyDbHandler db = new MyDbHandler(DeleteCustomerGroup.this);
...
//                final String[] action = {""};
                    Context context = DeleteCustomerGroup.this;
...
//                                startActivity(new Intent(DeleteCustomerGroupName.this, ClearTableData.class));
                                    ...
                                    try {
                                        ...
                                        Log.d("dbsvm","DB_NAME  "+Params.DB_NAME);
                                         MyDbHandler db1=new MyDbHandler(DeleteCustomerGroup.this);
//                                         db1.dropGroupTablesAssociated(groupDatabaseName);
//                                        db1.deleteAllTables();
                                        db1.deleteCustomerGroup();

                                        ga.alertDialogBox(DeleteCustomerGroup.this, groupDatabaseName + " group deleted successfully", "Group Deleted Successfully");
                                    }
                                    catch (Exception e)
                                    {
                                        ga.alertDialogBox(DeleteCustomerGroup.this, "Unable to Delete group  ", "No Group Found To Delete");
//                                        ga.alertDialogBox(DeleteCustomerGroup.this,);
                                    }
                                    Params.DB_NAME=Params.DEFAULT_DB_NAME;
                                    MyDbHandler db2=new MyDbHandler(DeleteCustomerGroup.this);
                                    showAllCustomerGroups();
