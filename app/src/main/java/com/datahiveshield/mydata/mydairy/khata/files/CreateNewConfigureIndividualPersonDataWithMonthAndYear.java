...
public class CreateNewConfigureIndividualPersonDataWithMonthAndYear extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyDbHandlerIndividualPerson db = new MyDbHandlerIndividualPerson(com.datahiveshield.mydata.mydairy.khata.files.CreateNewConfigureIndividualPersonDataWithMonthAndYear.this);
...
//                DatePickerDialog datePickerDialog=new DatePickerDialog();
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        com.datahiveshield.mydata.mydairy.khata.files.CreateNewConfigureIndividualPersonDataWithMonthAndYear.this,
...
//                                newCustomerGroup.setCustomerGroupNameDatabase(configTableName);
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                                ...
                                ga.alertDialogBox(com.datahiveshield.mydata.mydairy.khata.files.CreateNewConfigureIndividualPersonDataWithMonthAndYear.this, configTableDataName + " person created successfully", "New person Created");
                                showAllCustomerGroups();
                            }
                        }else {
                            ga.alertDialogBox(com.datahiveshield.mydata.mydairy.khata.files.CreateNewConfigureIndividualPersonDataWithMonthAndYear.this, "Unable to create  person configuration .\nConfiguration with name '" + configTableDataName.replace("_"," ") +
                    ...
                    ga.alertDialogBox(com.datahiveshield.mydata.mydairy.khata.files.CreateNewConfigureIndividualPersonDataWithMonthAndYear.this, "Please enter a valid person name", "Empty person Name");
                }

//                startActivity(new Intent(CreateNewConfigureIndividualPersonDataWithMonthAndYear.this, DeleteDbData.class));
            }
        });
    }
