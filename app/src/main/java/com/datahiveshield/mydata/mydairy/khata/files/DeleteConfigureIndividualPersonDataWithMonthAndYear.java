...
public class DeleteConfigureIndividualPersonDataWithMonthAndYear extends Activity {
...
//            Typeface myFont=Typeface.createFromAsset(this.getAssets(),"fonts/TradeWinds-Regular.ttf");
        ...
        Log.d("dbsvm","Current person db name to show month in individual inside DeleteConfigure-----"+Params.CURRENT_GROUP_DB_NAME);
...
//        Params.DB_NAME = Params.Customer_Group_Storing_DB_NAME;//Storing all new database names int the same db, to fetch all later
        ...
        MyDbHandlerIndividualPerson db = new MyDbHandlerIndividualPerson(DeleteConfigureIndividualPersonDataWithMonthAndYear.this);
...
//                    ((EditText) child).setTextColor(DeleteConfigureIndividualPersonDataWithMonthAndYear.this.getResources().getColor(colorRes));
...
//                final String[] action = {""};
                Context context = DeleteConfigureIndividualPersonDataWithMonthAndYear.this;
...
//                                startActivity(new Intent(DeleteConfigureIndividualPersonDataWithMonthAndYearName.this, ClearTableData.class));
                                ...
                                try {
                                    ...
                                    MyDbHandlerIndividualPersonConfigs db1=new MyDbHandlerIndividualPersonConfigs(DeleteConfigureIndividualPersonDataWithMonthAndYear.this);
//                                    String path = context.getExternalFilesDir(null).getAbsolutePath()+"/."+Params.EmailId+"/"+Params.CURRENT_GROUP_CONFIG_DB_NAME;

                                    db1.deleteIndividualPersonConfig(groupDatabaseName);//Deleted successfully
                                    showAllCustomerGroups();
                                    ga.alertDialogBox(DeleteConfigureIndividualPersonDataWithMonthAndYear.this, groupDatabaseName + " person deleted successfully", "person Deleted Successfully");
                                }
                                catch (Exception e)
                                {
                                    ga.alertDialogBox(DeleteConfigureIndividualPersonDataWithMonthAndYear.this, "Unable to Delete person  ", "No Data Found To Delete");
//                                        ga.alertDialogBox(DeleteConfigureIndividualPersonDataWithMonthAndYear.this,);
                                }
